...
.links > a {
    ...
    <body style="background-color:#91e842">
      ...
      <center>
        ...
        <form action="/hacerEditar/<?php echo e($value->AYD2_CATEGORIA_ID); ?>" method="post">
          <table >
            <tr>
              <?php echo e(csrf_field()); ?>

              <td>Descripcion:</td>
              <td><input type="text" name="AYD2_CATEGORIA_descripcion" value="<?php echo e($value->AYD2_CATEGORIA_descripcion); ?>"></td>
            </tr>
